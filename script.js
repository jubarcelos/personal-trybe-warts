...
// submit.addEventListener('click', (event) => { 
//   const fullName = `Nome: ${document.querySelector('#input-name')} ${document.querySelector('#input-lastname').value}`;
//   const email = `Email: ${document.querySelector('#input-email').value}`;
//   const house = `Casa: ${document.querySelector('#house').value}`;
//   const family = `Família: ${checkSelected(document.querySelector('#label-family').value)}`;
//   const subjects = `Matérias: ${checkSelected(document.querySelector('#label-content').value)}`;
//   const rate = `Avaliação: ${checkSelected(document.querySelector('#label-rate').value)}`;
//   const comments = `Observações: ${document.querySelector('#textarea').value}`;

//   clearForm()

//   const answers = [fullName, email, house, family, subjects, rate, comments];
//   for (let index = 0; index < answers.length; index += 1) {
//     const newElement = document.createElement('p');
//     newElement.innerHTML = answers[index];
//     evaluationForm.appendChild(newElement);
//   }
// });


// const family = document.querySelectorAll('.family');
// const checkedOptionFamily = '';
// const familyChose = family.forEach(e => {
//   if (e.checked) { 
//    checkedOptionFamily = e.value;
//   }
// });

// const module = document.getElementsByClass('subject');
// const checkedOptionModule = ''
// module.forEach(e => {
//   if (e.checked) { 
//    checkedOptionModule= e.value;
//   }
// });

// const assessment = document.getElementsByName('rate');
// const checkedOptionAssessment = ''
// const assessmentChose = assessment.forEach(e => {
//   if (e.checked) { 
//    checkedOptionAssessment= e.value;
//   }
// });
